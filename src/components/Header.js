...
const Header = () => {
  return (
   <div className='min-h-[690px]' style={{ backgroundImage: 'url("https://www.whats-on-netflix.com/wp-content/uploads/2021/08/netflix-library-photo-scaled.jpg")', backgroundSize: 'cover' }}>
